    ...
    return (
        <>
            <nav className="w-full h-[50px] flex justify-between items-center px-5 py-10  ">
                <div className="font-bold text-2xl cursor-context-menu flex items-center gap-5 "> <p onClick={() => router.back()} className="text-black font-normal text-sm" >Back</p>  Welcome Arham Shafi 👋</div>
